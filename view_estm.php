...
<head>
    ...
    <title>Available Estimate</title>
...
<body>
    <div class="row">
        ...
        <div class='container col-8'>
            ...
            <h1 style="color:#fff;">Available Estimate</h1>
                ...
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            echo "<tr>";
                            echo "<td>" . $row["EST_NO"] . "</td>";
                            echo "<td>" . $row["CNAME"] . "</td>";
                            echo "<td>" . date("d-m-Y", strtotime($row["EST_DATE"])) . "</td>";
                            ...
                            echo '<td><a href="print2.php?id=' . $row["SID"] . '" class="btn btn-success"><i class="fa-regular fa-eye"></i></a></td>';
                        ...
                        echo "<tr><td colspan='5'>No estimate available.</td></tr>";
                    }
                    ?>
                </tbody>
            </table>
        ...
        $(document).ready(function () {
            $(".generate-qr").click(function (e) {
                ...
                var qr = new QRious({
                    ...
                    value: `upi://pay?pa=abc@paytm&mc=INR&tid=1234567890123456&tr=1234567890&tn=Payment%20Request&am=${totalAmount}&cu=INR`,
                    size: 300
                });
