...
<body>
    ...
    <div class='container col-9'>
        <h1 class='text-center' style="color:white;">Yesha Enterprises Invoice System</h1>
        <hr>
        ...
        <form method='post' action='create_inv.php' autocomplete='off'>
            <div class='row'>
                <div class='col-md-4'>
                    ...
                    <table class='table table-bordered'>
                        ...
                        <tbody id='product_tbody'>
                            <tr>
                                ...
                                <td><input type='checkbox' style="margin-left: 50px;" class='form-check-input gstin-checkbox'> </td>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            function updateMainFormFields() {
                ...
                selectedProducts.forEach(function (product) {
                    var newRow = '<tr>' +
                        ...
                        '<td><input type="text" required name="qty[]" class="form-control qty"></td>' +
                        '<td><input type="checkbox" style="margin-left: 50px;" class="form-check-input gstin-checkbox"></td>' +
                        '<td><input type="checkbox" style="margin-left: 50px;" class="form-check-input gstin-checkbox-less"></td>' +
                        '<td><input type="text" required name="gstprice[]" class="form-control gstprice"></td>' +
                        '<td><input type="text" required name="total[]" class="form-control total"></td>' +
                        '<td><input type="button" value="x" class="btn btn-danger btn-sm btn-row-remove"></td>' +
                        '</tr>';
            ...
            $("#btn-add-row").click(function () {
                ...
                row += "<td><input type='checkbox' name='gstin[]' style='margin-left: 50px;' class='form-check-input gstin-checkbox'></td>";
                row += "<td><input type='checkbox' style='margin-left: 50px;' class='form-check-input gstin-checkbox-less'></td>";
        ...
        // Get references to the menu item and submenu
        const invoiceMenu = document.getElementById("invoice-menu");
        const invoiceSubmenu = document.getElementById("invoice-submenu");

        // Add a click event listener to the invoice menu item
        invoiceMenu.addEventListener("click", function (event) {
            // Prevent the default link behavior
            event.preventDefault();

            // Toggle the visibility of the submenu
            invoiceSubmenu.classList.toggle("show");
    });
    </script>
